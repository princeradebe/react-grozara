...
const Features = () => {
  return (
    <div className="container mx-auto ">
      <div className="flex flex-col lg:flex-row justify-between items-center text-[#183631]">
        <img src="/assets/subhero.svg" alt="" />
        <div className="flex flex-col gap-5 items-start">
          <p className="text-[#7EC33F] font-medium text-lg items-start">Features</p>
          <p className="text-4xl font-bold items-start">Grozara Premium</p>
